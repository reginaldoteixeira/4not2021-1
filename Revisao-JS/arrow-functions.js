...
function megasena() {
    ...
    // Math.ramdom() -> retorna um númneor aleatório entre 0 e 1 (inclusive) e 1 (exclusive)    // Multiplicando por 60 -> temos um número entre 0 e 59 (fracionário)
...
// Quando não á argumentos, os parênteses marcam o lugar deles
