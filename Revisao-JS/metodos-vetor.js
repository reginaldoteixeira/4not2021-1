...
console.log(pets.filter(x => x.especia === 'gato'))
console.log(pets.filter(x => x.idade > 20))
console.log(pets.filter(x => x.sexo === 'F' && x.especia === 'papagaio'))

console.log('---------------------------------------------')

// map(): cria um novo vetor COM MESMO NÚMERO DE ELEMETOS do vetor original,
...
//Criando um novo vetor em que cada elemento correponde ao elemento do
// vetor original elevando ao quadrado
console.log(numeros.map(x => x ** 2))

console.log('---------------------------------------------')

// reduce(): reduz um vetor devalores a um único valor.
// Parâmetros:
